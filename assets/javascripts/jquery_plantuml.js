...
function done_deflating(e) {console.log("DDDDDDDDDDDDDDDDDDDDDDDDDD")
var done = 0;
$("img").each(function () {
  if (done==1) return;
...
$("img").each(function () {
  ...
  if (done==1) return;
  var u1 = $(this).attr("src");console.log("src"+u1)
  if (u1!=null) return;
  var u2 = $(this).attr("uml");console.log("uml"+u2)
  if (u2=="") return;
